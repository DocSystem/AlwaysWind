...
struct ContentView: View {
    ...
    var body: some View {
        ...
        let maxWindSpeed = String(format: "%.1f", averageData.wind.force_max)
        let minWindSpeed = String(format: "%.1f", averageData.wind.force_min)
        ...
        TabView {
            VStack {
                ...
                Image(systemName: "arrow.down")
                    .resizable()
                    .rotationEffect(Angle(degrees: self.compassHeading.degrees + Double(liveData.wind_rt.dir)))
            ...
            VStack {
                ...
                Image(systemName: "arrow.down")
                    .resizable()
                    .rotationEffect(Angle(degrees: self.compassHeading.degrees + Double(averageData.wind.dir_avg)))
                    .frame(width: UIScreen.main.bounds.width/3, height: UIScreen.main.bounds.width/3)
                    .aspectRatio(contentMode: .fit)
